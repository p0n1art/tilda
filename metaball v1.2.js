...
let domain=removeProtocol(window.location.origin);function startBlyad(e){var t,n,a,r,i,o,s,l,
	...
	if(t=document.getElementById("metaballs"),
		...
		function(){$.getScript("https://juniorxsound.github.io/Metaball_Simulation/js/MarchingCubes.js",
			function(){["iPad","iPhone","iPod"].indexOf(navigator.platform)>=0?startBlyad():startBlyad("free")})}),window.open("")});
