...
function tma__routeAuthorized() { var e = tma__getPath(); "members" === e[0] && e[1] && "login" === e[1] ? document.location.replace("/members/") : "members" === e[0] ? "login" === e[1] || "#popuup1" === e[1] || "recover-password" === e[1] ? (tma__loadFiles(["sign"]), tma__onFuncLoad("tma__sign__init", function() { tma__sign__init(e[1]) })) : "courses" === e[1] ? (tma__loadFiles(["userbar", "courses"]), tma__onFuncLoad("tma__courses__init", function() { tma__courses__init(e) })) : (tma__loadFiles(["userbar", "resources_page_list"]), tma__onFuncLoad("tma__resources__initPagesList", function() { tma__resources__initPagesList() })) : (tma__loadFiles(["resources_page"]), tma__onFuncLoad("tma__resources__initPage", function() { tma__resources__initPage() })) }

function tma__routeNotAuthorized() { var e = tma__getPath(); if ("members" === e[0] && e[1] && ("login" === e[1] || "#popup2" === e[1] || "recover-password" === e[1])) return tma__loadFiles(["sign"]), void tma__onFuncLoad("tma__sign__init", function() { tma__sign__init(e[1]) });
